...
public class UserLogin2 {
    ...
    static String savedUsername;  // Stores the registered username
    static String savedPassword;  // Stores the registered password
    static String firstName;      // Stores the user's first name
    static String lastName;       // Stores the user's last name
